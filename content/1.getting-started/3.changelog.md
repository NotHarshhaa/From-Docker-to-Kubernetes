...
#description
Our latest release introduces Docker Service Discovery DNS and Observability Platforms for advanced networking and monitoring. In Kubernetes, we've added Network Policies and Admission Controllers for enhanced security and access control. This release significantly improves service discovery, monitoring, and security capabilities for containerized applications.
...
::div{class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6"}
  ::div{class="bg-white/50 dark:bg-white/5 rounded-lg p-5 shadow-sm"}
    ...
    ::ul{class="space-y-2 list-disc list-inside text-gray-700 dark:text-gray-300"}
      - **Docker Service Discovery DNS**: Advanced service discovery and DNS management
      - **Docker Observability Platforms**: Comprehensive monitoring and tracing
      - **Service Discovery**: DNS-based resolution and health checks
  ...
  ::div{class="bg-white/50 dark:bg-white/5 rounded-lg p-5 shadow-sm"}
    ...
    ::
    ::ul{class="space-y-2 list-disc list-inside text-gray-700 dark:text-gray-300"}
      - **Kubernetes Network Policies**: Sophisticated network security
      - **Kubernetes Admission Controllers**: Advanced security controls
      - **Network Security**: Zero-trust networking patterns
      - **Access Control**: Dynamic policy enforcement
    ::
  ::
  ...
  ::div{class="col-span-1 md:col-span-2 bg-white/50 dark:bg-white/5 rounded-lg p-5 shadow-sm"}
    ...
    ::
    ::ul{class="space-y-2 list-disc list-inside text-gray-700 dark:text-gray-300"}
      - New v2.3.0 blog post with major release highlights
