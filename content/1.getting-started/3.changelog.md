...
#description
Our latest release adds comprehensive guides on Docker for edge computing, security scanning, and database containerization, along with advanced Kubernetes topics including event-driven autoscaling, FinOps cost management, and GitOps with Flux and ArgoCD.
...
::div{class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6"}
  ::div{class="bg-white/50 dark:bg-white/5 rounded-lg p-5 shadow-sm"}
    ...
    ::ul{class="space-y-2 list-disc list-inside text-gray-700 dark:text-gray-300"}
      ...
      - **Security Scanning & Vulnerability Management**: Comprehensive security practices
  ...
  ::div{class="bg-white/50 dark:bg-white/5 rounded-lg p-5 shadow-sm"}
    ...
    ::
    ::ul{class="space-y-2 list-disc list-inside text-gray-700 dark:text-gray-300"}
      - **Event-Driven Autoscaling (KEDA)**: Advanced scaling based on external metrics
      - **FinOps & Cost Management**: Optimizing cloud spend and implementing chargeback
      - **GitOps with Flux and ArgoCD**: Declarative infrastructure management
    ::
  ::
  ...
  ::div{class="col-span-1 md:col-span-2 bg-white/50 dark:bg-white/5 rounded-lg p-5 shadow-sm"}
    ...
    ::
    ::ul{class="space-y-2 list-disc list-inside text-gray-700 dark:text-gray-300"}
      - New v1.8.0 blog post with release highlights
