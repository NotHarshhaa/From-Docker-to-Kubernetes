...
::div{class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6"}
  ::div{class="bg-white/50 dark:bg-white/5 rounded-lg p-5 shadow-sm"}
    ...
    ::ul{class="space-y-2 list-disc list-inside text-gray-700 dark:text-gray-300"}
      - Multi-Architecture Builds (Docker)
      - Development Environments & Workflow Optimization
      - Docker Swarm: Native Clustering
      - GitOps: Flux CD & ArgoCD (Kubernetes)
      - Multi-Cluster Management
      - Cloud Native Security (4C's Model)
    ::
  ::
  ...
  ::div{class="bg-white/50 dark:bg-white/5 rounded-lg p-5 shadow-sm"}
    ...
    ::ul{class="space-y-2 list-disc list-inside text-gray-700 dark:text-gray-300"}
      ...
      - Improved code examples & workflow diagrams
      - Expanded troubleshooting guides
      - Enhanced enterprise and security content
    ::
  ::
::
::
